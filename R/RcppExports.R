...
RCKCpp <- function(I, IC, IF, V, R0, Rk, Ck, Cap, OCV, SOCList, IList, dt, SOCStart, trace, traceLimit) {
    .Call('_BatteryPrognostics_RCKCpp', PACKAGE = 'BatteryPrognostics', I, IC, IF, V, R0, Rk, Ck, Cap, OCV, SOCList, IList, dt, SOCStart, trace, traceLimit)
}
